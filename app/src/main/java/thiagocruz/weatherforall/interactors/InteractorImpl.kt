...
class InteractorImpl : InteractorInterface {
    ...
    private fun sortCityForecastListByUserDistance(list: List<CityForecast>, context: Context, listener: InteractorInterface.WeatherForecastListener) {
